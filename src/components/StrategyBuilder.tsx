...
import { computeCombinedMetrics } from './strategy-builder/computeCombinedMetrics';
...
export function StrategyBuilder({ strategies, onClose }: StrategyBuilderProps) {
  ...
  // Derive the combined view model. Memoized on the selection so the simulated
  // series inside computeCombinedMetrics stay stable between renders.
