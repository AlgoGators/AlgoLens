      ...
      <div className={`min-h-screen ${
        ...
        <div className={`sticky top-0 z-10 border-b ${
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
            <div>
              <h2 className="text-lg md:text-xl">STRATEGY BUILDER</h2>
              <p className={`text-xs ${
                theme === 'dark' ? 'text-gray-400' : 'text-gray-500'
              }`}>
                Test combinations • Real-time metrics
              </p>
            </div>
            <button
              onClick={onClose}
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2 text-xs">
                      <div>
                        <div className={theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}>VAL</div>
                        <div>${(strategy.currentValue / 1000).toFixed(0)}k</div>
                      </div>
                      <div>
                        <div className={theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}>RET</div>
                        <div className={isPositive ? 'text-orange-500' : 'text-red-500'}>
                          {isPositive ? '+' : ''}{strategy.returnPercent.toFixed(1)}%
                        </div>
                      </div>
                      <div>
                        <div className={theme === 'dark' ? 'text-gray-500' : 'text-gray-400'}>SR</div>
            ...
            <div className={`p-4 border ${
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  className={`text-xs ${
                    theme === 'dark' ? 'text-orange-500 hover:text-orange-400' : 'text-orange-600 hover:text-orange-700'
                  }`}
                >
                  {expandedSections.assetDetails ? 'Show Less' : 'Show All'}
                </button>
              </div>
              
              <div className="space-y-0">
                <div className={`grid grid-cols-12 gap-2 pb-2 border-b text-xs ${
                ...
                {(expandedSections.assetDetails 
                  ? combinedMetrics.assetAllocation 
                  : combinedMetrics.assetAllocation.slice(0, 6)
                ).map((asset, index) => (
                  <div
                    key={asset.symbol}
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className={`w-full p-3 border text-left flex items-center justify-between ${
                theme === 'dark' ? 'bg-gray-950 border-gray-800 hover:border-gray-700' : 'bg-gray-50 border-gray-200 hover:border-gray-300'
              }`}
            >
                              ...
                              <div 
                                ...
                                style={{
                                  backgroundColor: `rgba(${
                                    corr > 0.7 ? '239, 68, 68' : corr > 0.4 ? '251, 146, 60' : '34, 197, 94'
